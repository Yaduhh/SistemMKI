...
class StorePenawaranRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'diskon_satu' => 'nullable|numeric|min:0|max:100',
            'diskon_dua' => 'nullable|numeric|min:0|max:100',
    ...
    public function messages(): array
    {
        return [
            ...
            'diskon_satu.numeric' => 'Diskon satu harus berupa angka.',
            'diskon_satu.min' => 'Diskon satu minimal 0%.',
            'diskon_satu.max' => 'Diskon satu maksimal 100%.',
            'diskon_dua.numeric' => 'Diskon dua harus berupa angka.',
