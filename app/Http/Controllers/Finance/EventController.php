...
class EventController extends Controller
{
    ...
    public function upcoming()
    {
        ...
        return view('finance.events.upcoming', compact('events'));
    }
    ...
    public function myUpcoming()
    {
        ...
        return view('finance.events.my-upcoming', compact('events'));
    }
    ...
    public function past()
    {
        ...
        return view('finance.events.past', compact('events'));
    }
    ...
    public function show(Event $event)
    {
        ...
        return view('finance.events.show', compact('event', 'invitedUsers'));
    }

    /**
     * Display dashboard with upcoming events for finance.
     */
    public function dashboard()
    {
        ...
        return view('finance.events.dashboard', compact('upcomingEvents', 'recentPastEvents', 'myUpcomingEvents'));
    }
}
