...
class DailyActivityController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('finance.daily-activity.index', compact('activities', 'users', 'startDate', 'endDate'));
    }
    ...
    public function create()
    {
        ...
        $clients = Client::where('status_deleted', false)
                        ->orderBy('nama')
                        ->get();
        return view('finance.daily-activity.create', compact('users', 'clients'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('finance.daily-activity.show', $activity)
    ...
    public function show(DailyActivity $dailyActivity)
    {
        ...
        return view('finance.daily-activity.show', compact('dailyActivity'));
    }
    ...
    public function edit(DailyActivity $dailyActivity)
    {
        ...
        $clients = Client::where('status_deleted', false)
                        ->orderBy('nama')
                        ->get();
        return view('finance.daily-activity.edit', compact('dailyActivity', 'users', 'clients'));
    }
    ...
    public function update(Request $request, DailyActivity $dailyActivity)
    {
        ...
        return redirect()
            ->route('finance.daily-activity.show', $dailyActivity)
    ...
    public function destroy(DailyActivity $dailyActivity)
    {
        ...
        return redirect()
            ->route('finance.daily-activity.index')
