...
class ClientController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('finance.client.index', compact('clients', 'creators'));
    }
    ...
    {
        return view('finance.client.create');
    }
    ...
    {
        return view('finance.client.show', compact('client'));
    }
    ...
    {
        return view('finance.client.edit', compact('client'));
    }
