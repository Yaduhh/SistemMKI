                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div id="descriptionList" class="space-y-3">
                                    <div class="description-item flex items-start gap-2">
                                        <div class="flex-grow">
                                            <input type="text" 
                                                name="descriptions[]" 
                                                class="block w-full rounded-xl border-gray-300 py-3 px-3 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-zinc-700 dark:text-white sm:text-sm"
                                ...
                                <button type="button" 
                                    ...
                                    class="inline-flex items-center mt-2 px-3 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-zinc-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
