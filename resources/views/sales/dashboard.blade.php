<x-layouts.sales>
    <div>
        ...
        <p class="mt-2 text-base text-gray-600 dark:text-gray-400">Berikut adalah ringkasan aktivitas penjualan Anda hari
            ini</p>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $clientCount }}
                                </dd>
                            </dl>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-2 gap-3 sm:grid-cols-3">
                ...
                <a href="https://instagram.com/wpcmegakomposit" target="_blank"
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-pink-500 to-purple-600 group-hover:from-pink-600 group-hover:to-purple-700 transition-all duration-200">
                ...
                <a href="https://tiktok.com/@wpc_mki" target="_blank"
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-lg bg-gray-900 group-hover:bg-zinc-900/30 transition-all duration-200">
                                <svg class="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                ...
                <a href="https://megakomposit.com" target="_blank"
                    ...
                    <div class="flex items-center space-x-3">
                        <div class="flex-shrink-0">
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-blue-600/30 to-blue-700/30 group-hover:from-blue-700/30 group-hover:to-blue-800/30 transition-all duration-200 overflow-hidden">
