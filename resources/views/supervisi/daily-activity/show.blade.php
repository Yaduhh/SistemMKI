            ...
            <div class="space-y-6">
                <div class="mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Detail Aktivitas</h1>
                            <p class="mt-1 text-sm text-zinc-600 dark:text-zinc-400">Informasi Aktivitas Harian</p>
                        </div>
                ...
                <div class="mb-8 overflow-hidden rounded-xl">
                    <div class="border-b border-zinc-200 dark:border-zinc-700">
                        ...
                        <div class="flex items-center justify-end my-4 gap-2">
                            <a href="{{ route('supervisi.daily-activity.edit', $dailyActivity) }}"
                            ...
                            <form action="{{ route('supervisi.daily-activity.destroy', $dailyActivity) }}" method="POST" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
                ...
                <div class="mt-8">
                    ...
                    <!-- Form Komentar -->
                    <div class="mt-6">
                        <form action="{{ route('supervisi.daily-activity.comment', $dailyActivity) }}" method="POST">
                            @csrf
