    ...
    <template id="entertaiment-material-row-template">
        <div class="grid grid-cols-1 md:grid-cols-7 gap-4 items-end p-6 rounded-xl mt-4 bg-gray-100 dark:bg-zinc-700/30 relative entertaiment-material-row pt-12">
            ...
            <div>
                ...
                <input type="text" data-material-field="sub_total" name="json_pengeluaran_entertaiment[__MRIDX__][materials][__MATIDX__][sub_total]" placeholder="Sub Total" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white sub-total-input" readonly />
            </div>
    ...
    <script>
        (function () {
            ...
            function updateGrandTotal() {
                ...
                grandTotalEl.className = 'entertaiment-grand-total';
            }
