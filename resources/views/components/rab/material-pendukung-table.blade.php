    ...
    <template id="material-row-template">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end p-6  bg-white dark:bg-zinc-700/30 relative material-row pt-12">
            ...
            <div>
                ...
                <input type="number" step="0.01" data-material-field="ppn" name="json_pengeluaran_material_pendukung[__MRIDX__][materials][__MATIDX__][ppn]" placeholder="0" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white ppn-input" value="0" />
            </div>
            <div>
        ...
        (function () {
            ...
            function setHiddenFieldValues(row, type) {
                ...
                const hiddenFields = [
                    ...
                    { name: 'qty', value: '' },
                    { name: 'satuan', value: '' },
                    { name: 'ppn', value: '0' } // PPN is always 0 for special rows
                ];
                        ...
                        if (itemInput && subTotalInput) {
                            ...
                            if (!isNaN(val)) {
                                ...
                                if (itemValue === 'Diskon') {
                                    ...
                                    // Untuk item lain (termasuk Ongkir), tambahkan ke total
                                    totalMr += val;
                                }
                            }
                        }
