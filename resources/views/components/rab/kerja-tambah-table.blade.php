                ...
                <template class="kerja-tambah-termin-row-template">
                    <div class="grid grid-cols-1 gap-2 items-center kerja-tambah-termin-row relative">
                        ...
                        <input type="text" name="json_kerja_tambah[__SECIDX__][termin][__TERIDX__][persentase]"
                            ...
                            readonly>
                        <input type="text" name="json_kerja_tambah[__SECIDX__][termin][__TERIDX__][status]"
                            value="Pengajuan"
                            class="border rounded-lg px-4 py-2.5 status-input dark:bg-zinc-800 dark:border-zinc-700 dark:text-white bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-200"
                            readonly>
            ...
            (function() {
                ...
                function updateStatusColor(statusInput) {
                    ...
                    statusInput.className =
                        'border rounded-lg px-4 py-2.5 status-input dark:bg-zinc-800 dark:border-zinc-700 dark:text-white';

                    if (status === 'Pengajuan') {
                        statusInput.classList.add('bg-yellow-100', 'dark:bg-yellow-900/30', 'text-yellow-800',
                            'dark:text-yellow-200');
                    } else if (status === 'Disetujui') {
                        statusInput.classList.add('bg-green-100', 'dark:bg-green-900/30', 'text-green-800',
                            'dark:text-green-200');
                ...
                } else if (window.existingKerjaTambah && Array.isArray(window.existingKerjaTambah) && window
                    .existingKerjaTambah.length > 0) {
