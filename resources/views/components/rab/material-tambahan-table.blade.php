<div>
    <div id="mr-list-tambahan" class="space-y-8">
        <!-- MR group akan di-generate oleh JS -->
    </div>
    <button type="button" class="dark:bg-indigo-900 bg-indigo-600 text-white py-2 uppercase w-full" id="add-mr-group-tambahan">Tambah MR</button>
    <div class="flex justify-end bg-indigo-600/10 py-2 px-4">
        <div class="font-semibold mr-2">Grand Total:</div>
        <div class="font-bold text-indigo-700 dark:text-indigo-400" id="grand-total-tambahan">0</div>
    </div>
    <template id="mr-group-template-tambahan">
        <div class="w-full relative mr-group">
            <div class="flex flex-col md:flex-row md:items-center gap-4 mb-4">
                <div class="w-full">
                    <label class="block text-sm font-medium mb-1">MR</label>
                    <input type="text" data-mr-field="mr" name="json_pengeluaran_material_tambahan[__MRIDX__][mr]" placeholder="MR 001" class="border w-full rounded-xl px-4 py-2 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" required />
                </div>
                <div class="w-full">
                    <label class="block text-sm font-medium mb-1">Tanggal</label> 
                    <input type="date" data-mr-field="tanggal" name="json_pengeluaran_material_tambahan[__MRIDX__][tanggal]" class="border rounded-xl w-full px-4 py-2 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" required />
                </div>
                <div>
            ...
            <div class="mt-4 flex justify-end border-t border-b border-indigo-600/30 bg-indigo-600/10 px-4 py-2">
                <div class="font-semibold mr-2">Total MR :</div>
                <div class="font-bold text-indigo-600 dark:text-indigo-400 total-mr">0</div>
            </div>
        </div>
    </template>
    <template id="material-row-template-tambahan">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end p-6  bg-white dark:bg-zinc-700/30 relative material-row pt-12">
            ...
            <div>
                ...
                <input type="text" data-material-field="item" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][item]" placeholder="Item" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Ukuran</label>
                <input type="text" data-material-field="ukuran" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][ukuran]" placeholder="Ukuran" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Panjang</label>
                <input type="text" data-material-field="panjang" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][panjang]" placeholder="Panjang" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Qty</label>
                <input type="number" min="0" data-material-field="qty" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][qty]" placeholder="Qty" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white qty-input" />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Satuan</label>
                <input type="text" data-material-field="satuan" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][satuan]" placeholder="Satuan" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" />
            </div>
            <div>
    ...
    <template id="diskon-row-template-tambahan">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end p-6 bg-yellow-50 dark:bg-yellow-900/20 relative material-row pt-12 border border-yellow-200 dark:border-yellow-800">
            <div>
                <label class="block text-xs font-medium mb-1">Item</label>
                <input type="text" data-material-field="item" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][item]" placeholder="Item" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" value="Diskon" readonly />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Persentase (%)</label>
                <input type="text" data-material-field="harga_satuan" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][harga_satuan]" placeholder="5.5" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white diskon-persen-input" />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Sub Total</label>
                <input type="text" data-material-field="sub_total" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][sub_total]" placeholder="Sub Total" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white sub-total-input" readonly />
    ...
    <template id="ongkir-row-template-tambahan">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 items-end p-6 bg-purple-50 dark:bg-purple-900/20 relative material-row pt-12 border border-purple-200 dark:border-purple-800">
            <div>
                <label class="block text-xs font-medium mb-1">Item</label>
                <input type="text" data-material-field="item" name="json_pengeluaran_material_tambahan[__MRIDX__][materials][__MATIDX__][item]" placeholder="Item" class="w-full border rounded-lg px-2 py-1 dark:bg-zinc-800 dark:border-zinc-700 dark:text-white" value="Ongkir" readonly />
            </div>
            <div>
                <label class="block text-xs font-medium mb-1">Sub Total</label>
    ...
    <script>
        (function () {
            const mrList = document.getElementById('mr-list-tambahan');
            ...
            function renderAllNames() {
                mrList.querySelectorAll('.mr-group').forEach((mrGroup, mrIdx) => {
                    ...
                    mrGroup.querySelectorAll('input[name^="json_pengeluaran_material_tambahan["]').forEach(input => {
                        let name = input.getAttribute('name');
                        name = name.replace(/json_pengeluaran_material_tambahan\[\d+\]/, `json_pengeluaran_material_tambahan[${mrIdx}]`);
            ...
            function setHiddenFieldValues(row, type) {
                ...
                hiddenFields.forEach(field => {
                    ...
                    hiddenInput.name = `json_pengeluaran_material_tambahan[${mrIdx}][materials][${matIdx}][${field.name}]`;
            ...
            function setupDiskonCalculation(mrGroup) {
                ...
                diskonInputs.forEach(input => {
                    input.addEventListener('input', function() {
                        ...
                        // Hitung total sub total dari item material tambahan yang ada di atas Diskon
                        let totalSubTotal = 0;
