...
@php
    ...
    $variants = [
        'primary' => 'bg-primary-600 hover:bg-primary-700 dark:text-white focus:ring-primary-500',
        ...
        'danger' => 'bg-red-600 hover:bg-red-700 dark:text-white focus:ring-red-500',
    ];
