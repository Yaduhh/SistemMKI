<x-layouts.app>
    ...
    <div class="py-12">
        <div class="w-full mx-auto">
            <x-card>
                <form action="{{ route('admin.wallpanel.update', $wallpanel) }}" method="POST" class="space-y-6"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            <flux:input 
                                ...
                                :value="old('nama_produk', $wallpanel->nama_produk)" 
                            />
                        </div>
                        ...
                        <div>
                            <flux:input 
                                ...
                                :value="old('harga', $wallpanel->harga)"
                            />
                        </div>

                        <div class="col-span-2">
                            <div class="flex items-center">
                                <input type="checkbox" name="status_aksesoris" id="status_aksesoris" value="1" {{ old('status_aksesoris', $wallpanel->status_aksesoris) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
