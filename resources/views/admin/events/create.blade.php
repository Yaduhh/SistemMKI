<x-layouts.app :title="__('Tambah Event Baru')">
    <div class="container mx-auto">
        <!-- Header Section -->
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('Tambah Event Baru') }}</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Buat event atau meeting baru dalam sistem') }}</p>
                </div>
        ...
        <div class="bg-white dark:bg-zinc-900/50 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <form method="POST" action="{{ route('admin.events.store') }}" class="p-6 space-y-6">
                @csrf
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <input type="hidden" name="peserta" id="pesertaInput" value="{{ json_encode(old('peserta', [])) }}" />
