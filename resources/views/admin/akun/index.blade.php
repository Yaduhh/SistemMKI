<x-layouts.app :title="__('Daftar Akun')">
    <div class="container mx-auto">
        <div class="w-full mx-auto">
            <div class="bg-white dark:bg-accent-foreground">
                        ...
                        <tbody class="bg-white dark:bg-accent-foreground divide-y divide-gray-200 dark:divide-gray-700">
                            @forelse ($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $user->role === 1 ? 'bg-purple-100 text-purple-800 dark:bg-purple-900 dark:text-purple-300' : 'bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300' }}">
