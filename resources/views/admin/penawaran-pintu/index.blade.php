<x-layouts.app>
    <x-slot name="header">
        <div class="flex justify-between items-center mb-6">
            ...
            <x-button href="{{ route('admin.penawaran-pintu.create') }}"
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex flex-wrap gap-3">
                            <x-button href="{{ route('admin.penawaran-pintu.show', $penawaran) }}"
                            ...
                            <x-button href="{{ route('admin.penawaran-pintu.edit', $penawaran) }}"
                            ...
                            <x-button href="{{ route('admin.penawaran-pintu.cetak', $penawaran) }}"
                            ...
                            <form action="{{ route('admin.penawaran-pintu.destroy', $penawaran) }}" method="POST"
                                onsubmit="return confirm('Yakin ingin menghapus penawaran pintu ini?')">
                                @csrf @method('DELETE')
            ...
            @empty
                <div class="col-span-full">
                    <div
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3">Belum ada penawaran pintu aktif
                        </h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-8">Mulai dengan membuat penawaran pintu pertama Anda
