<x-layouts.app :title="__('Pengeluaran Entertainment')">
    <div class="container mx-auto">
        <div class="mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-2xl font-bold">Pengeluaran Entertainment</h1>
                    <p class="text-zinc-600 dark:text-zinc-400">Kelola status pengeluaran entertainment dari RAB</p>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-4">
            ...
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                <div>
                    ...
                    <select name="status_filter" class="border border-zinc-300 dark:border-zinc-600 rounded-md px-3 py-2 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white">
                        <option value="">Semua Status</option>
                        <option value="Pengajuan" {{ request('status_filter') == 'Pengajuan' ? 'selected' : '' }}>Pengajuan</option>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.entertainment.index') }}" class="px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
                    ...
                    <tbody class="bg-white dark:bg-zinc-800 divide-y divide-zinc-200 dark:divide-zinc-700">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-zinc-900 dark:text-white">
                                    <div>
                                        ...
                                        <div class="text-zinc-500 dark:text-zinc-400">{{ $entertainment['rab_pekerjaan'] }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-zinc-900 dark:text-white">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    @php
                                        ...
                                        $color = $statusColors[$entertainment['status']] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200';
                                    @endphp
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                                                                 <button onclick="updateStatus({{ $entertainment['rab_id'] }}, {{ $entertainment['mr_index'] }}, {{ $entertainment['material_index'] }}, '{{ $entertainment['status'] }}')"
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="px-6 py-4 text-center text-sm text-zinc-500 dark:text-zinc-400">
    ...
    <div id="statusModal" class="fixed inset-0 bg-gray-600/30 backdrop-blur-sm dark:bg-zinc-900/30 hidden z-50">
        <div class="flex items-center justify-center min-h-screen">
            <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 w-96 border border-zinc-200 dark:border-zinc-400">
                <h3 class="text-lg font-medium text-zinc-900 dark:text-white mb-4">Update Status Entertainment</h3>
                <form id="statusForm" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="status" class="w-full border border-zinc-300 dark:border-zinc-600 rounded-md px-3 py-2 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white">
                            ...
                            <option value="Ditolak">Ditolak</option>
                               ...
                               <button type="button" onclick="closeStatusModal()" class="px-4 py-2 border border-zinc-300 dark:border-zinc-600 rounded-md text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-700 flex items-center gap-2">
                                   <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
