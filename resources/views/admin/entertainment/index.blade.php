        ...
        <div class="mb-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-zinc-600 dark:text-zinc-400 text-sm lg:text-base">
                        Kelola status pengeluaran non material
                    </p>
                </div>
            </div>
        </div>
            ...
            @forelse($entertainments as $entertainment)
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-4">
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center gap-3">
                            <div>
                                <h3 class="font-semibold text-zinc-900 dark:text-white">{{ $entertainment['rab_proyek'] }}</h3>
                                <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $entertainment['rab_pekerjaan'] }}</p>
                            </div>
                        </div>
                        @php
                            $statusColors = [
                    ...
                    <!-- Supervisi Info -->
                    @if(!empty($entertainment['supervisi_nama']))
                        <div class="mb-4 p-3 bg-zinc-50 dark:bg-zinc-700/50 rounded-lg">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ $entertainment['supervisi_nama'] }}</span>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ $entertainment['qty'] }} {{ $entertainment['satuan'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="mb-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        <div class="mb-2">
                            ...
                            <p class="text-sm text-blue-600 dark:text-blue-400 ml-6">{{ $entertainment['supplier'] }}</p>
                        </div>
                        <div>
                            <div class="flex items-center gap-2 mb-1">
                                <svg class="w-4 h-4 text-blue-500 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <p class="text-sm text-blue-600 dark:text-blue-400 ml-6">{{ $entertainment['item'] }}</p>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            ...
                            <p class="text-sm font-semibold text-green-600 dark:text-green-400">Rp {{ number_format($entertainment['harga_satuan'], 0, ',', '.') }}</p>
                        </div>
                        <div class="p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg">
                            ...
                            <p class="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Rp {{ number_format($entertainment['sub_total'], 0, ',', '.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                        @if ($entertainment['rab_status'] !== 'selesai')
                            <button
                                ...
                                class="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center justify-center gap-2 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-8 text-center">
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 dark:text-zinc-400">Belum ada pengeluaran non material yang tercatat.</p>
                        </div>
                    </div>
                </div>
            @endforelse
