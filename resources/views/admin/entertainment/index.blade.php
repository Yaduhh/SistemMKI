<x-layouts.app :title="__('Pengeluaran Entertainment')">
    <div class="container mx-auto">
        ...
        <!-- Filter Section -->
        <div
            class="mb-6 bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-4">
            ...
            <form method="GET" class="flex flex-wrap gap-4 items-end">
                <div>
                    ...
                    <select name="status_filter"
                        class="border border-zinc-300 dark:border-zinc-600 rounded-md px-3 py-2 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-white">
