                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-accent-foreground dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">{{ __('Area') }}</th>
                                <th scope="col" class="px-6 py-3">{{ __('Unit') }}</th>
                        ...
                        <tbody>
                            @forelse ($deckings as $decking)
                                <tr class="bg-white border-b dark:bg-accent-foreground dark:border-gray-700">
                                    ...
                                    <td class="px-6 py-4">
                                        {{ $decking->lebar }} x {{ $decking->tebal }} x {{ $decking->panjang }}
                                    </td>
                                    <td class="px-6 py-4">
                                        {{ $decking->luas_btg }} btg / {{ $decking->luas_m2 }} m²
                                    </td>
                                    <td class="px-6 py-4">{{ $decking->satuan }}</td>
