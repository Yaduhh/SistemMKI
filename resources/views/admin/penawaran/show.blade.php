<x-layouts.app :title="__('Detail Penawaran')">
            ...
            <div class="mb-6">
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                    <div class="mb-4 lg:mb-0">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Detail Penawaran</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Informasi lengkap penawaran
