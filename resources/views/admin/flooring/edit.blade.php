<x-layouts.app>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <x-button href="{{ route('admin.flooring.index') }}" variant="secondary">
    ...
    <div class="py-12">
        <div class="w-full mx-auto">
            <x-card>
                <form action="{{ route('admin.flooring.update', $flooring) }}" method="POST" class="space-y-6"
                    x-data="flooringForm({{ old('lebar', $flooring->lebar) }}, {{ old('panjang', $flooring->panjang) }})"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="col-span-2">
                            <flux:input 
                                ...
                                required 
                                autocomplete="off"
                                :placeholder="__('Enter flooring code')"
                                :value="old('code', $flooring->code)" 
                            />
                        </div>
                        ...
                        <div class="col-span-2">
                            <flux:input 
                                ...
                                :value="old('nama_produk', $flooring->nama_produk)" 
                            />
                        </div>
                        ...
                        <div class="grid grid-cols-12 gap-6">
                            <div class="col-span-5">
                                <flux:input 
                                    ...
                                    :value="old('lebar', $flooring->lebar)"
                            ...
                            <div class="col-span-5">
                                <flux:input 
                                    ...
                                    :value="old('tebal', $flooring->tebal)" 
                                />
                            </div>
                        ...
                        <flux:input 
                            ...
                            :value="old('panjang', $flooring->panjang)"
                        ...
                        <div>
                            <flux:input
                                ...
                                :value="old('luas_btg', $flooring->luas_btg)"
                        ...
                        <div>
                            <flux:input 
                                ...
                                :value="old('luas_m2', $flooring->luas_m2)"
                        ...
                        <div>
                            <flux:input 
                                ...
                                :value="old('harga', $flooring->harga)"
                            />
                        </div>

                        <div class="col-span-2">
                            <div class="flex items-center">
                                <input type="checkbox" name="status_aksesoris" id="status_aksesoris" value="1" {{ old('status_aksesoris', $flooring->status_aksesoris) ? 'checked' : '' }} class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('flooringForm', (initialLebar = 0, initialPanjang = 0) => ({
                lebar: initialLebar,
