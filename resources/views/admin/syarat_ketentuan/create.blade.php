        ...
        <div class="w-full mx-auto">
            ...
            <div class="mb-4">
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                    <div class="mb-4">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Tambah Syarat & Ketentuan</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Tambahkan syarat dan ketentuan baru</p>
                    </div>
                </div>
            </div>
