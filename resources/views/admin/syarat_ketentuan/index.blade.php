            ...
            <div class="mb-4">
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                    <div class="mb-4 lg:mb-0">
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Daftar Syarat & Ketentuan</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Kelola semua syarat dan ketentuan yang berlaku untuk layanan Anda</p>
                    </div>
                    <a href="{{ route('admin.syarat_ketentuan.create') }}"
            ...
            @if($syaratKetentuan->isEmpty())
                <div class="bg-white dark:bg-zinc-900/30 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <div class="text-center py-12">
                        ...
                        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Belum ada syarat & ketentuan</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-6">Mulai dengan menambahkan syarat & ketentuan pertama Anda</p>
                        <a href="{{ route('admin.syarat_ketentuan.create') }}"
            ...
            @else
                <div class="bg-white dark:bg-zinc-900/30 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="hidden md:block bg-gray-50 dark:bg-zinc-800 px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="grid grid-cols-12 gap-4">
                            ...
                            <div class="col-span-9">
                                <span class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Syarat & Ketentuan</span>
                            </div>
                    ...
                    <div class="divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($syaratKetentuan as $index => $item)
                            <div class="px-4 md:px-6 py-4 hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition-colors duration-200">
                                ...
                                <div class="md:hidden space-y-3 flex flex-row-reverse justify-between">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-2">
                                            <a href="{{ route('admin.syarat_ketentuan.edit', $item->id) }}"
                                            ...
                                            <form action="{{ route('admin.syarat_ketentuan.destroy', $item->id) }}" method="POST" class="inline-block"
                                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus syarat & ketentuan ini?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                    ...
                                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $index + 1 }}. {{ $item->syarat }}</p>
                                </div>
                                ...
                                <div class="hidden md:grid grid-cols-12 gap-4 items-center">
                                    ...
                                    <div class="col-span-9">
                                        <p class="text-sm text-gray-600 dark:text-gray-400">{{ $item->syarat }}</p>
                                    </div>
                                    <div class="col-span-1">
