<x-layouts.app>
    ...
    <div class="py-12">
        <div class="w-full mx-auto">
            <x-card>
                <form action="{{ route('admin.pintu.update', $pintu) }}" method="POST" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="col-span-2">
                            <flux:input 
                                ...
                                :value="old('nama_produk', $pintu->nama_produk)" 
                            />
                        </div>

                        <div class="grid grid-cols-12 gap-6" x-data="{ isAksesoris: {{ $pintu->status_aksesoris ? 'true' : 'false' }} }">
