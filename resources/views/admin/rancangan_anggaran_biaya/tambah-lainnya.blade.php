<x-layouts.app :title="__('Tambah Pengeluaran Lainnya')">
    <div class="container mx-auto">
        <div class="w-full mx-auto">
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-2xl font-bold">Tambah Pengeluaran Lainnya</h1>
            ...
            <form action="{{ route('admin.rancangan-anggaran-biaya.store-lainnya', $rancanganAnggaranBiaya) }}" method="POST">
                @csrf
                ...
                <div class="mt-8">
                    <div class="flex items-center justify-between gap-4 mb-6">
                        ...
                        <h2 class="text-lg font-semibold w-full text-center bg-pink-600 dark:bg-pink-600/30 py-2 uppercase text-white">
