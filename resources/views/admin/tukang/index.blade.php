            ...
            @forelse($tukangs as $tukang)
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-4">
                    ...
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center gap-3">
                            <div>
                                <h3 class="font-semibold text-zinc-900 dark:text-white">{{ $tukang['rab_proyek'] }}</h3>
                                <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $tukang['rab_pekerjaan'] }}</p>
                            </div>
                        </div>
                        @php
                            $statusColors = [
                            ...
                            $color = $statusColors[$tukang['status']] ?? 'bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200';
                        @endphp
                    ...
                    <!-- Supervisi Info -->
                    @if(!empty($tukang['supervisi_nama']))
                        <div class="mb-4 p-3 bg-zinc-50 dark:bg-zinc-700/50 rounded-lg">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ $tukang['supervisi_nama'] }}</span>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-zinc-600 dark:text-zinc-400">{{ $tukang['persentase'] }}</span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div class="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="text-sm font-medium text-blue-700 dark:text-blue-300">Debet</span>
                            </div>
                            <p class="text-sm font-semibold text-blue-600 dark:text-blue-400">Rp {{ number_format($tukang['debet'], 0, ',', '.') }}</p>
                        </div>
                        ...
                        <div class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            ...
                            <p class="text-sm font-semibold text-green-600 dark:text-green-400">Rp {{ number_format($tukang['kredit'], 0, ',', '.') }}</p>
                        </div>
                        ...
                        <div class="p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="text-sm font-medium text-purple-700 dark:text-purple-300">Sisa</span>
                            </div>
                            <p class="text-sm font-semibold text-purple-600 dark:text-purple-400">Rp {{ number_format($tukang['sisa'], 0, ',', '.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 pt-4 border-t border-zinc-200 dark:border-zinc-700">
                        @if($tukang['rab_status'] !== 'selesai')
                            <button
                                ...
                                class="flex-1 bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-md text-sm font-medium flex items-center justify-center gap-2 transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-sm border border-zinc-200 dark:border-zinc-700 p-8 text-center">
                    <div class="flex flex-col items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-zinc-500 dark:text-zinc-400">Belum ada pengeluaran tukang yang tercatat.</p>
                        </div>
                    </div>
                </div>
            @endforelse
