                    ...
                    <div
                        ...
                        <div class="border-b border-gray-200 p-4 dark:border-gray-700">
                            ...
                            @if (auth()->id() === $activity->created_by)
                                <div class="flex items-center gap-2 justify-end mt-4">
                                    <a href="{{ route('admin.daily-activity.edit', $activity) }}"
                                    ...
                                    <form action="{{ route('admin.daily-activity.destroy', $activity) }}"
                        ...
                        <div class="grid grid-cols-1 gap-4 p-4">
                            ...
                            <div class="space-y-4">
                                ...
                                <!-- Pihak Bersangkutan -->
                                @if ($activity->pihak_bersangkutan)
                                    <div class="flex items-start gap-3">
                                        <div class="flex h-10 w-10 shrink-0 justify-center rounded-full">
                                            <svg class="h-6 w-6" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                        ...
                                        <div>
                                            <h4 class="font-medium text-gray-900 dark:text-white">Pihak Bersangkutan</h4>
                                            <p class="mt-1 text-gray-600 dark:text-gray-400">
                                                @if ($activity->client)
                                                    {{ Str::limit($activity->client->nama, 100) }}
                                                @else
                                                    {{ Str::limit($activity->pihak_bersangkutan, 100) }}
                                                @endif
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex items-center justify-between flex-1">
                                    ...
                                    <a href="{{ route('admin.daily-activity.show', $activity) }}"
