<x-layouts.app :title="__('Tambah Aktivitas')">
    <div class="container mx-auto">
        <div class="mb-8 space-y-4">
            <div class="px-4 py-3 rounded-xl w-fit bg-emerald-800/10 text-primary dark:bg-emerald-400/30 flex items-center gap-2">
        ...
        <div class="">
            <form action="{{ route('admin.daily-activity.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg">
                        <div class="space-y-1 text-center">
                            ...
                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                <label for="dokumentasi" class="relative px-2 py-1 cursor-pointer bg-white dark:bg-zinc-900 rounded-md font-medium text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-emerald-500">
                                    <span>Upload gambar</span>
                                    <input id="dokumentasi" name="dokumentasi[]" type="file" class="sr-only" multiple accept="image/*">
                                </label>
                                <p class="pl-3 py-1">atau drag and drop</p>
                            </div>
                ...
                <div class="bg-white dark:bg-zinc-900/50 rounded-xl border border-gray-200 dark:border-gray-700/50 shadow-sm backdrop-blur-sm p-6">
                            ...
                            preview.innerHTML = `
                                <div class="relative aspect-square rounded-lg overflow-hidden">
                                    ...
                                    <div class="absolute inset-0 bg-black bg-opacity-40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                        <button type="button" class="text-white hover:text-red-400 transition-colors" onclick="this.closest('.relative').remove()">
                                            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
