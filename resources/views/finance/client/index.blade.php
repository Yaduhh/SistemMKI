<x-layouts.finance :title="__('Daftar Pelanggan')">
    @php
        ...
        <div class="w-full mx-auto">
            ...
            <div class="mb-4">
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center">
                    ...
                    <a href="{{ route('finance.client.create') }}"
            ...
            <div class="mb-6 bg-white dark:bg-zinc-900/30 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                <form method="GET" action="{{ route('finance.client.index') }}" class="space-y-4">
            ...
            @if($clients->count() > 0)
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    @foreach($clients as $client)
                        <div class="bg-white h-full flex flex-col justify-between dark:bg-zinc-900/30 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow duration-200">
                            <!-- Card Header -->
                            ...
                            <div class="px-6 py-4 space-y-2">
                                ...
                                @if($client->email)
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-blue-600 dark:text-blue-400">{{ $client->email }}</span>
                                    </div>
                                @endif
                                ...
                                @if($client->notelp)
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-purple-600 dark:text-purple-400">{{ $client->notelp }}</span>
                                    </div>
                                @endif
                                ...
                                @if($client->nama_perusahaan)
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm text-rose-600 dark:text-rose-400">{{ $client->nama_perusahaan }}</span>
                                    </div>
                                @endif
                                ...
                                @if($client->alamat)
                                    <div class="flex items-center">
                                        <svg class="w-4 h-4 text-cyan-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                        </svg>
                                        <span class="text-sm text-cyan-600 dark:text-cyan-400">{{ $client->alamat }}</span>
                                    </div>
                                @endif

                                <!-- Created Date -->
                                <div class="flex items-center">
                                    <svg class="w-4 h-4 text-amber-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                    </svg>
                                    <span class="text-sm text-amber-600 dark:text-amber-400">Dibuat: {{ $client->created_at->format('d/m/Y') }}</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-indigo-600 dark:text-indigo-400">Oleh: {{ $client->creator->name ?? 'Tidak diketahui' }}</span>
                                </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-emerald-600 dark:text-emerald-400">Total: {{ $client->dailyActivities()->where('deleted_status', false)->count() }} Kunjungan</span>
                                </div>
                            ...
                            <div class="px-6 py-4 bg-zinc-50 dark:bg-zinc-700 border-t border-gray-200 dark:border-gray-600">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <form action="{{ route('finance.client.destroy', $client) }}" method="POST" class="inline-block"
