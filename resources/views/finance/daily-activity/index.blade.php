<x-layouts.finance :title="__('Aktivitas Harian')">
    <div class="flex flex-col gap-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            ...
            <a href="{{ route('finance.daily-activity.create') }}"
        ...
        <div
            ...
            <div class="p-4 sm:p-6">
                <form action="{{ route('finance.daily-activity.index') }}" method="GET" class="space-y-4">
                        ...
                        <div class="border-b border-gray-200 p-4 dark:border-gray-700">
                            ...
                            @if (auth()->id() === $activity->created_by)
                                <div class="flex items-center gap-2 justify-end mt-4">
                                    <a href="{{ route('finance.daily-activity.edit', $activity) }}"
                                    ...
                                    <form action="{{ route('finance.daily-activity.destroy', $activity) }}"
                        ...
                        <div class="grid grid-cols-1 gap-4 p-4">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex items-center justify-between flex-1">
                                    ...
                                    <a href="{{ route('finance.daily-activity.show', $activity) }}"
