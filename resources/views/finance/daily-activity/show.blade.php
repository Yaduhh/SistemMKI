    ...
    <div class="container mx-auto">
        ...
        <div class="mb-8 overflow-hidden rounded-xl">
            <div class="border-b border-zinc-200 dark:border-zinc-700">
                ...
                @if(auth()->id() === $dailyActivity->created_by)
                    <div class="flex items-center justify-end my-4 gap-2">
                        <a href="{{ route('finance.daily-activity.edit', $dailyActivity) }}"
                        ...
                        <form action="{{ route('finance.daily-activity.destroy', $dailyActivity) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
        ...
        <div class="mt-8">
            ...
            <!-- Form Komentar -->
            <div class="mt-6">
                <form action="{{ route('finance.daily-activity.comment', $dailyActivity) }}" method="POST">
                    @csrf
