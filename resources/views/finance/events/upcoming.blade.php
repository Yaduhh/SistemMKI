<x-layouts.finance :title="__('Event Mendatang')">
    <div class="container mx-auto">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row lg:items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Daftar semua event yang akan datang') }}</p>
                </div>
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">{{ __('Belum ada event yang dijadwalkan untuk saat ini.') }}</p>
                <a href="{{ route('finance.events.dashboard') }}"
