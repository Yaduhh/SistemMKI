<x-layouts.finance :title="__('Event Selesai')">
    <div class="container mx-auto">
        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row lg:items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">{{ __('Daftar semua event yang telah selesai') }}</p>
                </div>
                <div class="flex mt-4 lg:mt-0 items-center space-x-3">
                        ...
                        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-2">
                                    <a href="{{ route('finance.events.show', $event) }}"
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 mb-6">{{ __('Belum ada event yang telah selesai.') }}</p>
                <a href="{{ route('finance.events.dashboard') }}"
